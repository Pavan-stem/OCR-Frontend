export const translations = {
    en: {
        ...
        upload: {
            ...
            page1: "Page 1",
            page2: "Page 2",
            page1Full: "Page 1 · Members Register",
            page2Full: "Page 2 · Financial Ledger",
            page1And2Missing: "Page 1 & Page 2 are missing.",
            page1Missing: "Page 1 is missing.",
            page2Missing: "Page 2 is missing.",
            page1NeedsValidation: "Page 1 needs validation.",
            page2NeedsValidation: "Page 2 needs validation.",
            bothPagesNeedValidation: "Both pages need validation.",
            page1MissingPage2NeedsValidation: "Page 1 missing, Page 2 needs validation.",
            page2MissingPage1NeedsValidation: "Page 2 missing, Page 1 needs validation.",
            page1And2NeedReupload: "Page 1 & 2 need to be re-uploaded and validated.",
            page1NeedsReupload: "Page 1 needs to be re-uploaded and validated.",
            page2NeedsReupload: "Page 2 needs to be re-uploaded and validated.",
            reuploadValidationNote: "Validate the re-uploaded page before submitting.",
            pageRejected: "Page {{page}} Rejected",
        ...
        conversion: {
            ...
            saveSyncSuccess: 'Page {{page}} saved and sent to DB!',
    ...
    te: {
        ...
        header: {
            ...
            cancel: "వద్దు",
            profileShort: "ప్రొఫైల్",
            historyShort: "చరిత్ర",
            logoutShort: "లాగ్అవుట్",
        },
        ...
        upload: {
            ...
            page1: "పేజీ 1",
            page2: "పేజీ 2",
            page1Full: "పేజీ 1 · సభ్యుల రిజిస్టర్",
            page2Full: "పేజీ 2 · ఆర్థిక లెడ్జర్",
            page1And2Missing: "పేజీ 1 మరియు పేజీ 2 లేవు.",
            page1Missing: "పేజీ 1 లేదు.",
            page2Missing: "పేజీ 2 లేదు.",
            page1NeedsValidation: "పేజీ 1 ధృవీకరణ అవసరం.",
            page2NeedsValidation: "పేజీ 2 ధృవీకరణ అవసరం.",
            bothPagesNeedValidation: "రెండు పేజీలకు ధృవీకరణ అవసరం.",
            page1MissingPage2NeedsValidation: "పేజీ 1 లేదు, పేజీ 2 కి ధృవీకరణ అవసరం.",
            page2MissingPage1NeedsValidation: "పేజీ 2 లేదు, పేజీ 1 కి ధృవీకరణ అవసరం.",
            page1And2NeedReupload: "పేజీ 1 మరియు 2లను మళ్లీ అప్‌లోడ్ చేసి ధృవీకరించాలి.",
            page1NeedsReupload: "పేజీ 1ని మళ్లీ అప్‌లోడ్ చేసి ధృవీకరించాలి.",
            page2NeedsReupload: "పేజీ 2ని మళ్లీ అప్‌లోడ్ చేసి ధృవీకరించాలి.",
            reuploadValidationNote: "సమర్పించే ముందు మళ్లీ అప్‌లోడ్ చేసిన పేజీని ధృవీకరించండి.",
            pageRejected: "పేజీ {{page}} తిరస్కరించబడింది",
        ...
        conversion: {
            ...
            saveSyncSuccess: 'పేజీ {{page}} సేవ్ చేయబడింది మరియు డేటాబేస్కు పంపబడింది!',
