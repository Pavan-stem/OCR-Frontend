                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                {Object.values(group.pages).some(p => p.isSynced) && (
                                                                    <span className={`text-[8px] font-black px-1.5 py-0.5 rounded uppercase tracking-tighter ${
                                                                        Object.values(group.pages).some(p => p.isEdited) 
                        ...
                        {!loading && groupedResults.length > 0 && (
                            <div className="p-4 border-t border-gray-100 flex items-center justify-between bg-gray-50/50">
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl bg-white border border-gray-200 text-gray-700 font-bold text-xs hover:bg-gray-50 shadow-sm transition-all ${currentPage === 1 ? 'invisible' : ''}`}
                                >
                                    Previous
                                </button>
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-xl bg-white border border-gray-200 text-gray-700 font-bold text-xs hover:bg-gray-50 shadow-sm transition-all ${currentPage === totalPages ? 'invisible' : ''}`}
                                >
                                    Next
                                </button>
                            </div>
