...
const DashboardTab = ({ filterProps }) => {
  ...
  return (
    <div className="relative overflow-x-hidden min-h-screen">
      ...
      {/* Unified Tooltip Rendering - Wrapped in zero-size absolute container to prevent any layout insertion */}
      <div className="absolute h-0 w-0 overflow-hidden pointer-events-none">
        {
          (hoveredPoint || hoveredDistrict !== null) && tooltipPos.x !== -1 && createPortal(
            <div
